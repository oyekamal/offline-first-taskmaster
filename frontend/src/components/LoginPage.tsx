      ...
      <div className="max-w-md w-full mx-4">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Offline-first task management</p>
          </div>
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            ...
            <div className="space-y-1 text-sm text-gray-700">
              <p><span className="font-medium">Email:</span> user1@test.com (Admin)</p>
              <p><span className="font-medium">Password:</span> testpass123</p>
            </div>
            <p className="text-xs text-gray-500 mt-2">
              Other users: user2@test.com, user3@test.com, user4@test.com, user5@test.com
            </p>
          </div>

          {/* Features */}
          <div className="mt-6 pt-6 border-t border-gray-200">
            <p className="text-xs text-gray-500 text-center mb-3">Features</p>
        ...
        <p className="text-center text-sm text-gray-600 mt-6">
          Powered by React, Dexie.js & Django
        </p>
      </div>
    </div>
  );
